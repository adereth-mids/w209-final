...
var generateHouseLegend = function() {
    ...
    var x = d3.scaleLinear().domain([0, Object.keys(houseColor).length - 1]).range([margin.left, width - margin.right]);
...
var getCharacterCount = function(episode) {
	...
	//Li .attr("fill", function(d) { return "#ff0000"; })
		...
		//		console.log([d.id, characterHouseMap[d.id]])
	    ...
	    })// Li: color per house -->d.house not working
    ...
    var ready = function(_, episodes, groups) {
